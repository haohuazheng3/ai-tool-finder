...
import { getListingForRedirect } from '@/lib/db/queries'
...
export async function POST(req: NextRequest) {
  ...
  // Don't create a paid session for a listing that doesn't exist.
  const listing = await getListingForRedirect(Number(listingId))
  if (!listing) {
