CREATE TYPE "public"."listing_status" AS ENUM('live', 'pending', 'rejected');--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "listings_featured_idx" ON "listings" USING btree ("featured");